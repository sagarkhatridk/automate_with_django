...
def compress(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            resposne = HttpResponse(buffer.getvalue(), content_type=f'image/{output_format.lower()}')
            resposne['Content-Disposition'] = f'attechment; filename=compressed_{original_img}'
            return resposne
